...
// returns the category list
	...
	@ApiOperation(value = "Updates partially a Category", nickname = "patchServiceTestSpecification", notes = "Thisoperation updates partially a Category entity.", response = Category.class )
